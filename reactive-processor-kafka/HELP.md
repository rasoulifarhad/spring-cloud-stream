...
* The original package name 'com.example.cloud.my-simple-cloud-stream' is invalid and this project uses 'com.example.cloud.mysimplecloudstream' instead.
...
* [Spring Integration](https://docs.spring.io/spring-boot/docs/2.6.9/reference/htmlsingle/#messaging.spring-integration)
