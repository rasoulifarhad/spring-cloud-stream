...
public class FunctionTests {
	...
	public void testUppercase() {
		String output = this.functions.uppercaseFunction().apply("foobar");
		assertThat(output).isEqualTo("FOOBAR");
	}

	@Test
	public void testLowercase() {
		Flux<String> output = this.functions.lowercaseFluxFunction().apply(Flux.just("FOO", "BAR"));
	...
	public void testHello() {
		String output = this.functions.helloSupplier().get();
